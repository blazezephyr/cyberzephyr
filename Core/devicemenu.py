...
def Custom():
	...
	try:
		...
		Browser = input(green + "root@BlazeZephyr/Device/Custom:~ ")
		if not Browser.strip():
			print(alert + " [!] Error: Browser name cannot be empty")
			return
			
		print(alert + " Enter Device")
		Device = input("root@BlazeZephyr/Device/Custom:~ ")
		if not Device.strip():
			print(alert + " [!] Error: Device name cannot be empty")
			return
			
	except KeyboardInterrupt:
		logger.info("User interrupted Custom function")
		print("\nOperation cancelled by user")
		return
	except EOFError:
		logger.error("EOF encountered in Custom function")
...
def AllNeed():
	...
	try:
		...
		print("")
		DevicePick = int(input(green + "root@BlazeZephyr/Device:~ " + white))
		
	except ValueError:
		logger.error("Invalid input in AllNeed - not a number")
		print("\n[!] Error: Please enter a valid number")
		return
	except KeyboardInterrupt:
		logger.info("User interrupted AllNeed function")
		print("\nOperation cancelled by user")
		return
	except EOFError:
		logger.error("EOF encountered in AllNeed function")
		print("\n[!] Error: Input interrupted")
		return
	except Exception as e:
		logger.error(f"Error in AllNeed input: {e}")
		print(f"[!] Error: {e}")
		return
	...
	try:
		...
		logger.error(f"Error in AllNeed device selection: {e}")
		print(f"[!] Error: {e}")
		return
